...
* Argument names with dots (e.g., `age.limits`) have been deprecated in favour of underscores (e.g., `age_limits`) in `contact_matrix()`. The old argument names still work but will produce deprecation warnings (#160).
