...
#>          contact.age.group
#> age.group      [0,1)     [1,5)   [5,15)      15+
#>    [0,1)  0.47302079 0.8222999 1.141309 5.899239
#>    [1,5)  0.08632643 1.9595715 1.337662 5.427193
#>    [5,15) 0.03197653 0.5178501 7.777144 6.282724
#>    15+    0.03445721 0.3673153 1.372291 9.537565
```
...
#>   60+     0.777533  4.347863 2.4972876
#> 
#> $demography
#>    age.group population proportion  year
#>       <char>      <num>      <num> <int>
...
#>  ---                                                                         
#> 225:       60+              83       TRUE 5.5512825            4 0.0005557099
#> 226:       60+              84      FALSE 8.7923845            1 0.0001389275
#> 227:       60+              84       TRUE 7.4017099            2 0.0002778550
#> 228:       60+              85       TRUE 3.1116575            3 0.0004167824
#> 229:       60+              90       TRUE 4.6707906            1 0.0001389275
```
...
#>   60+     0.7718688  4.405534 2.5376740
#> 
#> $demography
#>    age.group population proportion  year
#>       <char>      <num>      <num> <int>
...
#>   5:    [0,18)               1       TRUE 0.9967249           88 0.0122256182
#>  ---                                                                         
#> 225:       60+              83       TRUE 3.1097465            4 0.0005557099
#> 226:       60+              84      FALSE 3.1097465            1 0.0001389275
#> 227:       60+              84       TRUE 3.1097465            2 0.0002778550
#> 228:       60+              85       TRUE 3.1097465            3 0.0004167824
#> 229:       60+              90       TRUE 3.1097465            1 0.0001389275
```
