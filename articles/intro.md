...
#>           contact.age.group
#> age.group       [0,1)     [1,5)    [5,15)  [15,Inf)
#>   [0,1)    0.28012821 1.5445921  2.124825  9.613986
#>   [1,5)    0.27256578 3.6901547  2.154223 10.678332
#>   [5,15)   0.08350352 0.8778586 15.799739 11.972786
#>   [15,Inf) 0.05314348 0.8393119  2.637636 18.629199
```
...
demo_matrix <- polymod[country == "United Kingdom"] |>
  ...
  compute_matrix()
demo_matrix |> symmetrise(survey_pop = align_ages(custom_pop, demo_matrix))
#>           contact.age.group
