...
For recent UN World Population Prospects data, the `wpp2024` package is available from GitHub (`remotes::install_github("PPgp/wpp2024")`). It comes as 1-year bands; relabel them to age groups with `limits_to_agegroups()` and `align_ages()` coarsens them to the matrix's age groups:
