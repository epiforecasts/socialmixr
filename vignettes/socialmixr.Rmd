...
For recent UN World Population Prospects data, the `wpp2024` package is available from GitHub (`remotes::install_github("PPgp/wpp2024")`). It comes as 1-year `lower.age.limit` bands, which `align_ages()` coarsens to the matrix's age groups:
