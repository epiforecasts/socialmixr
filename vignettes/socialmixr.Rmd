...
For recent UN World Population Prospects data, the `wpp2024` package is available from GitHub (`remotes::install_github("PPgp/wpp2024")`). It comes as 1-year `lower.age.limit` bands, which you coarsen to the matrix's age limits with `regroup_ages()`, then label as age groups:
...
uk_pop <- popAge1dt[name == "United Kingdom" & year == 2020,
  ...
  regroup_ages(age_limits = c(0, 1, 5, 15))
