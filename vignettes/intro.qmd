...
`survey_country_population()` looks up country-specific population data from the [`wpp2017`](https://cran.r-project.org/package=wpp2017) package, which is an optional (Suggests) dependency of socialmixr; install it separately to use this function. Passing population data directly (as above) is preferred where possible:
