...
```{r}
m <- contact_matrix(survey = "POLYMOD", countries = "United Kingdom", age.limits = c(0, 1, 5, 15), n=5)
length(m$matrices)
...
```{r}
contact_matrix(survey = "POLYMOD", countries = "United Kingdom", 
...
```{r}
contact_matrix(countries = "United Kingdom", age.limits = c(0, 1, 5, 15), split = TRUE)
```
