...
This generates a contact matrix from the UK part of the POLOYMOD study, with age groups 0-1, 1-5, 5-15 and 15+. This contains the mean number of contacts that each member of an age group (row) has reported with members of the same or another age group (column).
