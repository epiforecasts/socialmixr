...
socialmixr estimates matrices **empirically**, directly from the survey data. Smoothing or otherwise modelling the contact surface, and synthesising matrices for populations without survey data, are out of scope. For projected (synthetic) matrices covering countries without their own survey, see [contactdata](https://github.com/socialcontactdata/contactdata).
