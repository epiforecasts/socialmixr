...
#' @param missing.participant.age if set to "remove" (default), participants without age information are removed; if set to "keep", participants with missing age are kept and will appear in the contact matrix in a row labelled "NA".
...
contact_matrix <- function(
  ...
  if (need.survey.pop) {
    ...
    part.age.group.present <- get_age_group_lower_limits(age.limits)
